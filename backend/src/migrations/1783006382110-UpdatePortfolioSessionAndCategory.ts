...
export class UpdatePortfolioSessionAndCategory1783006382110 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "portfolio_sessions" DROP COLUMN "description"`,
    );
    await queryRunner.query(
      `ALTER TABLE "portfolio_sessions" DROP COLUMN "coverImageUrl"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "portfolio_sessions" ADD "coverImageUrl" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "portfolio_sessions" ADD "description" character varying`,
    );
  }
}
