...
export class RemoveExtraAboutFields1783006382111 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "about" ADD "phone" character varying`);
        await queryRunner.query(`ALTER TABLE "about" ADD "email" character varying`);
        await queryRunner.query(`ALTER TABLE "about" ADD "experience" character varying`);
